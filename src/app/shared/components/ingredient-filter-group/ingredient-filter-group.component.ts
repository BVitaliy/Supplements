...
@Component({
  selector: 'app-ingredient-filter-group',
  templateUrl: './ingredient-filter-group.component.html',
  styleUrls: ['./ingredient-filter-group.component.scss'],
})
export class IngredientFilterGroupComponent implements OnInit {
